...
const ViewProfileSidebar = ({ user }: { user: UserType }) => {
    return (
                ...
                <div className="mt-6">
                    ...
                    <ul>
                        ...
                        <li className="flex items-center gap-1 mb-3">
                            ...
                            <span className="w-[70%] text-neutral-500 dark:text-neutral-300 font-medium">: {user.email}</span>
                        </li>
                        <li className="flex items-center gap-1 mb-3">
                        ...
                        <li className="flex items-center gap-1 mb-3">
                            ...
                            <span className="w-[70%] text-neutral-500 dark:text-neutral-300 font-medium">: {user.createdAt}</span>
                        </li>

                        <li className="flex items-center gap-1 mb-3">
                            <span className="w-[30%] text-base font-semibold text-neutral-600 dark:text-neutral-200"> Dernière connexion</span>
                            <span className="w-[70%] text-neutral-500 dark:text-neutral-300 font-medium">: {user.lastLogin}</span>
                        </li>
