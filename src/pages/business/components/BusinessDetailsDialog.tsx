...
import { formatAmount, formatDate, getOwnerName } from "./business-utils";
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="!max-w-[760px]">
                <DialogHeader>
                    <DialogTitle>Détails du business</DialogTitle>
                    <DialogDescription>
                        Informations reçues depuis l&apos;API business.
                    </DialogDescription>
                </DialogHeader>
                ...
                {business && (
                    <div className="grid grid-cols-12 gap-4">
                        ...
                        <DetailItem label="Propriétaire" value={getOwnerName(business)} />
                        <DetailItem label="Téléphone" value={business.owner?.phone} />
                        <DetailItem label="Taxe" value={business.taxe?.title} />
                        <DetailItem label="Montant" value={business.taxe ? formatAmount(business.taxe.amount, business.taxe.currency) : null} />
                        ...
                        <DetailItem label="Lien carte" value={business.map_link ? <a href={business.map_link} target="_blank" rel="noreferrer" className="text-primary">Ouvrir la carte</a> : null} />
...
const DetailItem = ({ label, value }: DetailItemProps) => {
    return (
        <div className="md:col-span-6 col-span-12 rounded-lg border border-neutral-200 dark:border-slate-600 p-4">
